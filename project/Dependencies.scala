...
object Dependencies {
  ...
  // opentelemetry
  val opentelemetryApi = "io.opentelemetry" % "opentelemetry-api" % "1.42.1"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.37.0"
  ...
  val testTraits = "software.amazon.smithy" % "smithy-protocol-test-traits" % "1.52.0"
