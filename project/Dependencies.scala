...
object Dependencies {
  ...
  // Test
  val playAhcWS = "org.playframework" %% "play-ahc-ws" % "3.0.5" % Test
  val scalatestPlus = "org.scalatestplus.play" %% "scalatestplus-play" % "5.1.0" % Test

  // opentelemetry
  val opentelemetryApi = "io.opentelemetry" % "opentelemetry-api" % "1.40.0"
  val opentelemetryBom = "io.opentelemetry" % "opentelemetry-bom" % "1.40.0"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.32.0"
  ...
  val testTraits = "software.amazon.smithy" % "smithy-protocol-test-traits" % "1.50.0"
