...
object Dependencies {
  ...
  // Prod
  val slickPg = "com.github.tminglei" %% "slick-pg" % "0.22.1"
  val slickPgPlayJson = "com.github.tminglei" %% "slick-pg_play-json" % "0.22.1"
  val slickPgJts = "com.github.tminglei" %% "slick-pg_jts" % "0.22.1"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.28.1"
