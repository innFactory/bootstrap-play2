...
object Dependencies {
  ...
  val slickPgPlayJson = "com.github.tminglei" %% "slick-pg_play-json" % "0.21.1"
  val slickPgJts = "com.github.tminglei" %% "slick-pg_jts" % "0.21.1"
  ...
  // opentelemetry
  val opentelemetryApi = "io.opentelemetry" % "opentelemetry-api" % "1.35.0"
  val opentelemetryBom = "io.opentelemetry" % "opentelemetry-bom" % "1.35.0"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.25.0"
