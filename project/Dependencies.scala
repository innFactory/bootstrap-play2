...
object Dependencies {
  ...
  val playJsonJoda = "org.playframework" %% "play-json-joda" % "3.0.1"
  ...
  // opentelemetry
  val opentelemetryApi = "io.opentelemetry" % "opentelemetry-api" % "1.32.0"
  val opentelemetryBom = "io.opentelemetry" % "opentelemetry-bom" % "1.32.0"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.19.0"
  val logback = "ch.qos.logback" % "logback-classic" % "1.4.12"
  val logbackCore = "ch.qos.logback" % "logback-core" % "1.4.12"

  val nimbusJwt = "com.nimbusds" % "nimbus-jose-jwt" % "9.37.1"

  val firebase = "com.google.firebase" % "firebase-admin" % "9.2.0"

  val testTraits = "software.amazon.smithy" % "smithy-protocol-test-traits" % "1.41.1"
