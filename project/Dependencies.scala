...
object Dependencies {
  ...
  val playJson = "com.typesafe.play" %% "play-json" % "2.10.0"
  val playJsonJoda = "com.typesafe.play" %% "play-json-joda" % "2.10.0"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.15.0"
