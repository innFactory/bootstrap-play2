...
object Dependencies {
  ...
  val slickPgPlayJson = "com.github.tminglei" %% "slick-pg_play-json" % "0.21.0"
  val slickPgJts = "com.github.tminglei" %% "slick-pg_jts" % "0.21.0"
  ...
  val joda = "joda-time" % "joda-time" % "2.11.1"
