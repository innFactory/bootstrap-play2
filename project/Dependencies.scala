...
object Dependencies {
  ...
  val joda = "joda-time" % "joda-time" % "2.11.2"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.0.3"
  val logback = "ch.qos.logback" % "logback-classic" % "1.4.3"
  val logbackCore = "ch.qos.logback" % "logback-core" % "1.4.3"
