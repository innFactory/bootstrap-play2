...
object Dependencies {
  ...
  val playJsonJoda = "org.playframework" %% "play-json-joda" % "3.0.3"
  ...
  // Test
  val playAhcWS = "org.playframework" %% "play-ahc-ws" % "3.0.3" % Test
  val scalatestPlus = "org.scalatestplus.play" %% "scalatestplus-play" % "5.1.0" % Test

  // opentelemetry
  val opentelemetryApi = "io.opentelemetry" % "opentelemetry-api" % "1.38.0"
  val opentelemetryBom = "io.opentelemetry" % "opentelemetry-bom" % "1.38.0"
  ...
  val sharedDeps = "com.google.cloud" % "google-cloud-shared-dependencies" % "3.30.0"
  val logback = "ch.qos.logback" % "logback-classic" % "1.5.6"
  val logbackCore = "ch.qos.logback" % "logback-core" % "1.5.6"

  val nimbusJwt = "com.nimbusds" % "nimbus-jose-jwt" % "9.39"

  val firebase = "com.google.firebase" % "firebase-admin" % "9.2.0"

  val testTraits = "software.amazon.smithy" % "smithy-protocol-test-traits" % "1.49.0"
